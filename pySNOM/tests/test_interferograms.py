...
class test_Neaspectrum(unittest.TestCase):
    ...
    def test_multichannel_process(self):
        ...
        np.testing.assert_almost_equal(s_multichannel.data["O3A"][500],23.338979395903074)
        np.testing.assert_almost_equal(s_multichannel.data["O3P"][500],0.26155207185723767)
        np.testing.assert_almost_equal(s_multichannel.data["Wavenumber"][500],1273.6684340046547)
    ...
    def test_fullauto_process(self):
        ...
        np.testing.assert_almost_equal(s_allpoints.data["O3P"][500],0.26155207185723767)
        np.testing.assert_almost_equal(s_allpoints.data["Wavenumber"][500],1273.6684340046547)
