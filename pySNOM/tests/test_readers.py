...
class TestReaders(unittest.TestCase):
    def test_gwyread(self):
        ...
        np.testing.assert_almost_equal(data[7][7], 15.213262557983398)
        np.testing.assert_almost_equal(data[8][8], 15.736936569213867)
        np.testing.assert_almost_equal(data[9][9], 13.609171867370605)
